...
import type { Producto, ProductoForm } from "@/interfaces/producto.interface";
import useActualizarProductos from "@/hooks/productos/useActualizarProductos";

interface Inputs extends ProductoForm {}

interface ActualizarProductosProps {
  producto: Producto;
}
const ActualizarProductos: FC<ActualizarProductosProps> = ({ producto }) => {
  const { isPending, mutateAsync } = useActualizarProductos();
  ...
  const {
    ...
    defaultValues: {
      cantidad_producto: producto.inventario?.cantidad,
